...
('1002', 'Feijão 1kg', 7.00, 9.99, 150, 'kg'),
('1003', 'Óleo de Soja 900ml', 8.00, 12.50, 200, 'ml'),
('1004', 'Açúcar 5kg', 12.00, 17.99, 120, 'kg'),
('1005', 'Sal 1kg', 2.50, 4.50, 300, 'kg'),
('2001', 'Leite UHT 1L', 4.00, 6.50, 250, 'l'),
('2002', 'Café Torrado 500g', 9.50, 14.99, 180, 'g'),
('2003', 'Manteiga 200g', 6.00, 8.90, 100, 'g'),
('3001', 'Detergente Líquido 500ml', 2.00, 3.75, 400, 'ml'),
('3002', 'Papel Higiênico (4 rolos)', 5.50, 8.75, 350, 'rolos'),
('4001', 'Macarrão 1kg', 3.00, 5.50, 220, 'kg'),
...
(NOW(), 125.47, 'Cartão de Crédito'),
(DATE_SUB(NOW(), INTERVAL 1 DAY), 56.98, 'À Vista'),
...
(1, '3002', 1, 8.75),   -- Venda 1: 1 x Papel Higiênico
(2, '1002', 5, 9.99),  -- Venda 2: 5 x Feijão
(2, '1005', 2, 4.50),   -- Venda 2: 2 x Sal
(3, '1003', 4, 12.50),  -- Venda 3: 4 x Óleo
(3, '4001', 1, 5.50);   -- Venda 3: 1 x Macarrão
